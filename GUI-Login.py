...
class MySchoolApp(customtkinter.CTk):
    ...
    def kelasSiswa(self):
        ...
        imagge = Image.open('Ungu Kuning Ceria Seru Jadwal Pelajaran Sekolah.png')
        new_size = (650, 650)
        imagge_resized = imagge.resize(new_size)
        imagge_tk = ImageTk.PhotoImage(imagge_resized)
        self.background_labelkelas = ct.CTkLabel(master=self.kelasFrame, image=imagge_tk, text="")
        self.background_labelkelas.place(relx=0.5, rely=0.30, anchor=tkinter.N)
