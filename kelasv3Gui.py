...
def update():
    ...
    try:
        cursor.connection.ping()
        # sql=f"UPDATE kelas SET 'namaKelas' = '{nama}', 'tingkatKelas' = '{tingkat}', 'waliKelas' = '{wali}', 'ketuaKelas' = '{ketua}', 'jumlah' = '{jum}'"
...
# Button
saveBtn=Button(manageFrame,text="SAVE",width=10,borderwidth=3,bg=buttonColor,fg='white')
updateBtn=Button(manageFrame,text="UPDATE",width=10,borderwidth=3,bg=buttonColor,fg='white', command=update)
deleteBtn=Button(manageFrame,text="DELETE",width=10,borderwidth=3,bg=buttonColor,fg='white')
selectBtn=Button(manageFrame,text="SELECT",width=10,borderwidth=3,bg=buttonColor,fg='white')
findBtn=Button(manageFrame,text="FIND",width=10,borderwidth=3,bg=buttonColor,fg='white')
clearBtn=Button(manageFrame,text="CLEAR",width=10,borderwidth=3,bg=buttonColor,fg='white')
exportBtn=Button(manageFrame,text="EXPORT",width=10,borderwidth=3,bg=buttonColor,fg='white')
...
exportBtn.grid(row=0,column=5,padx=5,pady=5)
