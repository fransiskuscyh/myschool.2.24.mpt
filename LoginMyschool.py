...
from mataPel import *
from matPelSiswa import *
from nilai import *
from nilaiSiswa import *
from kelasFix import *
from absenPengurus import *
from absenSiswa import * 
from pengurus import *
from dbConnect import *
from testSiswa import *
from kelasMapel import *
...
class MySchoolApp(customtkinter.CTk):
    ...
    def background_GUI(self):
        for i in self.winfo_children():
            i.destroy()
        self.frame1 = ct.CTkFrame(master=self, width=1085,height=660, fg_color='grey')
        self.frame1.place(rely=0.5,relx=0.5,anchor=tkinter.CENTER)
        self.backframez = ct.CTkFrame(master=self.frame1, width=400, height=660, fg_color='orange', corner_radius=0)
    ...
    def listMenuPengurus(self):
        self.menu_pengurusFrame = ct.CTkFrame(master=self, width=170, height=1085, corner_radius=0, fg_color='blue')
    ...
    def profile_pengurus(self):
        for x in self.winfo_children():
            x.destroy()
        self.listMenuPengurus()
        self.profileFrame = ct.CTkFrame(master=self, width=830, height=600, fg_color='grey93', corner_radius=0)
    ...
    def mataPelajaranPengurus(self):
        ...
        myschool_matpel = mataPelajaranPengurus(curr_dbApp,conn_dbApp,self)
    ...
    def absensiPengurus(self):
        ...
        myschool_absen = absenPengurus(curr_dbApp,conn_dbApp,self)
        myschool_absen.uiAbsenPengurus(self.absensiFrame)
    ...
    def listMenuSiswa(self):
        self.menu_siswaFrame = ct.CTkFrame(master=self, width=170, height=1085, corner_radius=0, fg_color='blue')
    ...
    def nilaiSiswa(self):
        ...
        self.nilaiFrame = ct.CTkFrame(master=self, width=830, height=600, fg_color='white', corner_radius=0)
        self.nilaiFrame.place(relx=0.17,rely=0.5,anchor=tkinter.W)
        myschool_nilai = nilaiSiswa(curr_dbApp, conn_dbApp,self)
        myschool_nilai.nilaiSiswaUi(self.nilaiFrame)
    ...
    def absensiSiswa(self):
        ...
        self.absensiFrame = ct.CTkFrame(master=self, width=830, height=600, fg_color='white', corner_radius=0)
        self.absensiFrame.place(relx=0.17,rely=0.5,anchor=tkinter.W)
        myschool_absen = absenSiswa(curr_dbApp,conn_dbApp,self)
        myschool_absen.uiAbsenSiswa(self.absensiFrame)
    ...
    def __mataPelajaranSiswa(self):
        for x in self.winfo_children():
            x.destroy()
        self.listMenuSiswa()
        self.matpelFrame = ct.CTkFrame(master=self, width=980, height=670, fg_color='grey93', corner_radius=0)
        self.matpelFrame.place(relx=0.18,rely=0.3,anchor=tkinter.W)
        myschool_matpel = mataPelajaranSiswa(curr_dbApp,conn_dbApp,self)
